...
<body>
  ...
  <main class="main">
    <div class="first_screen">
      ...
      <h2 class="h2">Грузы от 100 до 2500 кг</h2>
      <table class="price">
      ...
      <form action="#" class="form">
        <span class="form_title">Оставьте заявку и мы перезвоним</span>
        <input class="input_text" type="text" placeholder="Имя">
        <input class="phone_inp" type="tel" placeholder="Телефон">
        <label class="form_label"><input type="checkbox">Даю согласие на обработку персональных данных</input></label>
