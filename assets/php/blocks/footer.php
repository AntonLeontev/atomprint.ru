<footer class="footer">
	<div class="footer_content">
		<form method="post" action="/thanks_page.php" id="callback_footer" onsubmit="ym('53149000','reachGoal', 'footerform');">
			...
			<input type="hidden" id="footer_page_title_input" name="page-title" value="Нет данных" />
			<label class="consent"><input type="checkbox" required />Даю согласие на обработку персональных данных</label>
			<input class="input_submit" type="submit" name="btn" class="btn" value="Заказать звонок">
		</form>
		<div class="footer_info2">
			<p class="footer_text">ООО "Атомпринт"</p>
			<p class="footer_text">ИНН 6670434981</p>
			<p class="footer_text">КПП 667001001</p>
		</div>
		...
		<div class="copyright">
			<div style="float: left;">
				© ООО "Атомпринт" 2010 - <?= (date('Y')) ?>
			</div>
			<div style="float: right;">
				Разработка и продвижение: <a href="https://vk.com/light_inthe_darkness" rel="nofollow">Леонтьев Антон</a>
			</div>
